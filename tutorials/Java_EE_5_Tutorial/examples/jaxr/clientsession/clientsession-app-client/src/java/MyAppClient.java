...
import sb.PubQueryRemote;
import java.util.ResourceBundle;


/**
 * The MyAppClient class is the client program for this
 * application.  It calls the bean's business methods.
 */
public class MyAppClient {
    @EJB(name = "PubQueryRemote")
    private static PubQueryRemote publisher;
    ...
    public void doTest() {
        ...
        try {
            ...
            publisher.executeQuery(registryBundle.getString("org.name"));
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }
